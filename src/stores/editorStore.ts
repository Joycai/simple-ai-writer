...
interface EditorState {
  ...
  /**
   * Both counters in one `set()`: the caller (setContent) runs on every
   * keystroke, and two separate writes meant every subscriber got notified
   * twice per character typed.
   */
