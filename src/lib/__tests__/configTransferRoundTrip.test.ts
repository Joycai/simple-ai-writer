...
const { listModels, listPrompts, listProviders, modelUpsert, promptUpsert, providerUpsert } =
  await import("../ai/configDb");
const { parseConfigBundle, CONFIG_BACKUP_KIND } = await import("../ai/configTransfer");
type Provider = import("../ai/configDb").Provider;
type Model = import("../ai/configDb").Model;
type Prompt = import("../ai/configDb").Prompt;
type ImageCaps = import("../ai/configDb").ImageCaps;
