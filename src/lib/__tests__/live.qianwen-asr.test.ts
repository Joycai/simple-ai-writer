...
import { transcribeSync } from "../asr/sync";
import { parseSyncTranscript } from "../asr/result";
import type { AsrConn } from "../asr/client";

const KEY = process.env.QIANWEN_KEY ?? "";
const BASE = "https://dashscope.aliyuncs.com/compatible-mode/v1";
const WAV = readFileSync(fileURLToPath(new URL("../asr/__tests__/fixtures/hello-world.wav", import.meta.url)));
