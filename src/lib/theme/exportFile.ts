...
const ROLES: Record<string, { zh: string; en: string }> = {
  ...
  "--color-type-vision-bg": { zh: "模型类型标签 · 视觉理解", en: "model type tag · vision" },
  "--color-type-vision-fg": { zh: "同上，字色", en: "same, foreground" },
  "--color-type-asr-bg": { zh: "模型类型标签 · 音频 ASR", en: "model type tag · audio ASR" },
  "--color-type-asr-fg": { zh: "同上，字色", en: "same, foreground" },
