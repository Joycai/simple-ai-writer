...
> Status: `partial` — §2.0（`ToolContext.onProgress` 缝 + translate）、§2.2 A（轮次秒表）、§3.1（子运行卡改成结构判定）已并入 [#420](https://github.com/Joycai/simple-ai-writer/pull/420)；§2.1 / §2.2 B / §2.3 仍是提案。
>
