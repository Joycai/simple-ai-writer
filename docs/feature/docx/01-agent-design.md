...
> **仍未做**：首页不同的页眉页脚、页眉横线、章节各自重新编号。可行性与实测在 [00-feasibility.md](00-feasibility.md)，UI 任务书在 [02-ui-brief.md](02-ui-brief.md)。
...
| **三期 · 已实施** | 页眉页脚与页码（含奇偶页不同）· 标题多级自动编号 · `parseDocFormat` 归一层 · 预设进应用配置备份 |
