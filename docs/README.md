...
| [code-structure-plan.md](feature/code-structure-plan.md) | `planned` | 源码结构整改（2026-09-19 审查）：4 组循环依赖（25 个文件）、`lib → stores` 的 7 个文件、store 间 50 处动态导入、三个 3000+ 行的文件——按 P0–P7 分阶段，P0 先装棘轮守卫，§2 是进度表，§7 记偏离 |
