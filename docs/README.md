...
| [comfyui-plan.md](feature/comfyui-plan.md) | `PR1–PR2 shipped` (Beta flag) | 本地 ComfyUI 作为第五条出图路由：一个 Model = 一张导出的 API 格式工作流，占位注入而非构图；参考图/图生图走 LoadImage 槽位，edit 能力从图推导；PR3 人设校准循环待做 |
