...
| [code-structure-plan.md](feature/code-structure-plan.md) | `shipped` | 源码结构整改（2026-09-19 审查）：4 组循环依赖（24 个文件）→ 0、`lib → stores` 7 个文件 → 0、store 间 61 处动态导入 → 17（理由写在守卫里）、三个 3000+ 行的文件拆到 1500 行以下——P0–P7，§3 前后对照，§7 记偏离，`layering.test.ts` 守着 |
