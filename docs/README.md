...
| [measurements/search-tools-ab-2026-09.md](feature/agent/measurements/search-tools-ab-2026-09.md) | `research` | `search_tools` A/B on spark-x2.5-4b, 2026-09-17：常驻 39/50 · 延迟第一版 30/50 · 第二版 33/50；不需要延迟工具的两格不掉分，需要的三格掉一到两次 |
